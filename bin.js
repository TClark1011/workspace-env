  ...
  "../../node_modules/.pnpm/yaml@2.4.2/node_modules/yaml/dist/visit.js"(exports2) {
    ...
    function callVisitor(key, node, visitor, path3) {
      ...
      if (identity.isSeq(node))
        return (_b3 = visitor.Seq) == null ? void 0 : _b3.call(visitor, key, node, path3);
      ...
      if (identity.isAlias(node))
        return (_e2 = visitor.Alias) == null ? void 0 : _e2.call(visitor, key, node, path3);
      return void 0;
    }
  ...
  "../../node_modules/.pnpm/yaml@2.4.2/node_modules/yaml/dist/doc/createNode.js"(exports2) {
    ...
    function findTagObject(value, tagName, tags) {
      ...
      if (tagName) {
        ...
        const tagObj = (_a4 = match2.find((t) => !t.format)) != null ? _a4 : match2[0];
        if (!tagObj)
      ...
      return tags.find((t) => {
        var _a5;
        return ((_a5 = t.identify) == null ? void 0 : _a5.call(t, value)) && !t.format;
      });
    }
    function createNode(value, tagName, ctx) {
      ...
      if (identity.isPair(value)) {
        const map = (_b3 = (_a4 = ctx.schema[identity.MAP]).createNode) == null ? void 0 : _b3.call(_a4, ctx.schema, null, ctx);
  ...
  "../../node_modules/.pnpm/yaml@2.4.2/node_modules/yaml/dist/stringify/stringify.js"(exports2) {
    ...
    function getTagObject(tags, item) {
      ...
      if (item.tag) {
        ...
        if (match2.length > 0)
          return (_a4 = match2.find((t) => t.format === item.format)) != null ? _a4 : match2[0];
      }
      let tagObj = void 0;
      let obj;
      if (identity.isScalar(item)) {
        ...
        const match2 = tags.filter((t) => {
          var _a5;
          return (_a5 = t.identify) == null ? void 0 : _a5.call(t, obj);
        });
        tagObj = (_b3 = match2.find((t) => t.format === item.format)) != null ? _b3 : match2.find((t) => !t.format);
      } else {
        obj = item;
        tagObj = tags.find((t) => t.nodeClass && obj instanceof t.nodeClass);
      }
      if (!tagObj) {
        const name = (_d2 = (_c2 = obj == null ? void 0 : obj.constructor) == null ? void 0 : _c2.name) != null ? _d2 : typeof obj;
    ...
    function stringify(item, ctx, onComment, onChompKeep) {
      ...
      if (props.length > 0)
        ctx.indentAtStart = ((_b3 = ctx.indentAtStart) != null ? _b3 : 0) + props.length + 1;
...
${ctx.indent}`;
        ...
        const flow = (_b3 = (_a4 = ctx.inFlow) != null ? _a4 : value.flow) != null ? _b3 : value.items.length === 0;
        if (hasNewline || !flow) {
...
var require_stringifyCollection = __commonJS({
  "../../node_modules/.pnpm/yaml@2.4.2/node_modules/yaml/dist/stringify/stringifyCollection.js"(exports2) {
    ...
    function stringifyCollection(collection, ctx, options) {
      var _a4;
      const flow = (_a4 = ctx.inFlow) != null ? _a4 : collection.flow;
  ...
  "../../node_modules/.pnpm/yaml@2.4.2/node_modules/yaml/dist/nodes/YAMLMap.js"(exports2) {
    ...
    var YAMLMap = class extends Collection.Collection {
      ...
      get(key, keepScalar) {
        ...
        return (_a4 = !keepScalar && identity.isScalar(node) ? node.value : node) != null ? _a4 : void 0;
      }
      has(key) {
...
${pair.key.commentBefore}` : item.commentBefore;
            if (item.comment) {
              const cn = (_a4 = pair.value) != null ? _a4 : pair.key;
...
var require_resolve_block_map = __commonJS({
  "../../node_modules/.pnpm/yaml@2.4.2/node_modules/yaml/dist/compose/resolve-block-map.js"(exports2) {
    ...
    function resolveBlockMap({ composeNode, composeEmptyNode }, ctx, bm, onError, tag) {
      var _a4, _b3;
      const NodeClass = (_a4 = tag == null ? void 0 : tag.nodeClass) != null ? _a4 : YAMLMap.YAMLMap;
      ...
      for (const collItem of bm.items) {
        ...
        const keyProps = resolveProps.resolveProps(start, {
          ...
          next: key != null ? key : sep2 == null ? void 0 : sep2[0],
          offset,
          onError,
          startOnNewline: true
        });
        ...
        } else if (((_b3 = keyProps.found) == null ? void 0 : _b3.indent) !== bm.indent) {
          onError(offset, "BAD_INDENT", startColMsg);
        }
        ...
        const valueProps = resolveProps.resolveProps(sep2 != null ? sep2 : [], {
...
var require_resolve_block_seq = __commonJS({
  "../../node_modules/.pnpm/yaml@2.4.2/node_modules/yaml/dist/compose/resolve-block-seq.js"(exports2) {
    ...
    function resolveBlockSeq({ composeNode, composeEmptyNode }, ctx, bs, onError, tag) {
      var _a4;
      const NodeClass = (_a4 = tag == null ? void 0 : tag.nodeClass) != null ? _a4 : YAMLSeq.YAMLSeq;
...
var require_resolve_flow_collection = __commonJS({
  "../../node_modules/.pnpm/yaml@2.4.2/node_modules/yaml/dist/compose/resolve-flow-collection.js"(exports2) {
    ...
    function resolveFlowCollection({ composeNode, composeEmptyNode }, ctx, fc, onError, tag) {
      ...
      const NodeClass = (_a4 = tag == null ? void 0 : tag.nodeClass) != null ? _a4 : isMap ? YAMLMap.YAMLMap : YAMLSeq.YAMLSeq;
          ...
          if (props.comment) {
            ...
            if (prevItemComment) {
              ...
              if (identity.isPair(prev))
                prev = (_b3 = prev.value) != null ? _b3 : prev.key;
              if (prev.comment)
                prev.comment += "\n" + prevItemComment;
              else
...
var require_compose_collection = __commonJS({
  "../../node_modules/.pnpm/yaml@2.4.2/node_modules/yaml/dist/compose/compose-collection.js"(exports2) {
    ...
    function composeCollection(CN, ctx, token, tagToken, onError) {
      ...
      const res = (_b3 = (_a4 = tag.resolve) == null ? void 0 : _a4.call(tag, coll, (msg) => onError(tagToken, "TAG_RESOLVE_FAILED", msg), ctx.options)) != null ? _b3 : coll;
...
var require_resolve_flow_scalar = __commonJS({
  "../../node_modules/.pnpm/yaml@2.4.2/node_modules/yaml/dist/compose/resolve-flow-scalar.js"(exports2) {
    ...
    function foldLines(source) {
      ...
      return res + sep2 + ((_a4 = match2 == null ? void 0 : match2[1]) != null ? _a4 : "");
    }
  ...
  "../../node_modules/.pnpm/yaml@2.4.2/node_modules/yaml/dist/compose/compose-scalar.js"(exports2) {
    ...
    function findScalarTagByName(schema, value, tagName, tagToken, onError) {
      ...
      for (const tag of matchWithTest)
        if ((_a4 = tag.test) == null ? void 0 : _a4.test(value))
          return tag;
    ...
    function findScalarTagByTest({ directives, schema }, value, token, onError) {
      ...
      const tag = schema.tags.find((tag2) => {
        var _a5;
        return tag2.default && ((_a5 = tag2.test) == null ? void 0 : _a5.test(value));
      }) || schema[identity.SCALAR];
      if (schema.compat) {
        const compat = (_a4 = schema.compat.find((tag2) => {
          var _a5;
          return tag2.default && ((_a5 = tag2.test) == null ? void 0 : _a5.test(value));
        })) != null ? _a4 : schema[identity.SCALAR];
...
var require_cst_scalar = __commonJS({
  "../../node_modules/.pnpm/yaml@2.4.2/node_modules/yaml/dist/parse/cst-scalar.js"(exports2) {
    ...
    function createScalarToken(value, context) {
      ...
      const end = (_a4 = context.end) != null ? _a4 : [
  ...
  "../../node_modules/.pnpm/yaml@2.4.2/node_modules/yaml/dist/parse/lexer.js"(exports2) {
    ...
    var Lexer = class {
      ...
      *lex(source, incomplete = false) {
        ...
        let next = (_a4 = this.next) != null ? _a4 : "stream";
    ...
    function getPrevProps(parent) {
      ...
      switch (parent.type) {
        ...
        case "block-map": {
          ...
          return (_a4 = it.sep) != null ? _a4 : it.start;
        }
        case "block-seq":
...
var require_public_api = __commonJS({
  "../../node_modules/.pnpm/yaml@2.4.2/node_modules/yaml/dist/public-api.js"(exports2) {
    ...
    function stringify(value, replacer, options) {
      ...
      if (value === void 0) {
        const { keepUndefined } = (_a4 = options != null ? options : replacer) != null ? _a4 : {};
        if (!keepUndefined)
          return void 0;
      }
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/Result.js
var require_Result = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/Result.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.safeAsync = exports2.isErr = exports2.isOk = exports2.err = exports2.ok = void 0;
    function ok(value) {
    ...
    exports2.safeAsync = safeAsync;
  }
});

// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/from.js
var require_from = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/from.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/type.js
var require_type = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/type.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.extendType = exports2.fromFn = exports2.typeDef = exports2.identity = void 0;
    ...
    exports2.extendType = extendType;
  }
});

// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/types.js
var require_types = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/types.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.array = exports2.optional = exports2.boolean = exports2.string = exports2.number = void 0;
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/positional.js
var require_positional = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/positional.js"(exports2) {
    "use strict";
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.positional = void 0;
    var Result = __importStar(require_Result());
    var types_1 = require_types();
    var chalk_1 = __importDefault(require_source());
    function fullPositional(config) {
      var _a4, _b3, _c2;
      const displayName = (_b3 = (_a4 = config.displayName) !== null && _a4 !== void 0 ? _a4 : config.type.displayName) !== null && _b3 !== void 0 ? _b3 : "arg";
      return {
        description: (_c2 = config.description) !== null && _c2 !== void 0 ? _c2 : config.type.description,
        helpTopics() {
          var _a5, _b4, _c3, _d2;
          const defaults2 = [];
          const defaultValueFn = (_a5 = config.defaultValue) !== null && _a5 !== void 0 ? _a5 : config.type.defaultValue;
          if (defaultValueFn) {
            try {
              const defaultValue = defaultValueFn();
              if ((_b4 = config.defaultValueIsSerializable) !== null && _b4 !== void 0 ? _b4 : config.type.defaultValueIsSerializable) {
                defaults2.push("default: " + chalk_1.default.italic(defaultValue));
              } else {
                defaults2.push("optional");
              }
            } catch (e) {
            }
          }
          const usage = defaults2.length > 0 ? `[${displayName}]` : `<${displayName}>`;
          return [
            {
              category: "arguments",
              usage,
              description: (_d2 = (_c3 = config.description) !== null && _c3 !== void 0 ? _c3 : config.type.description) !== null && _d2 !== void 0 ? _d2 : "self explanatory",
              defaults: defaults2
            }
          ];
        },
    ...
    exports2.positional = positional;
  }
});

// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/newparser/findOption.js
var require_findOption = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/newparser/findOption.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.findOption = void 0;
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/flag.js
var require_flag = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/flag.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.flag = exports2.fullFlag = exports2.boolean = void 0;
    ...
    function fullFlag(config) {
      var _a4;
      const decoder = (0, type_1.extendType)(exports2.boolean, config.type);
      return {
        description: (_a4 = config.description) !== null && _a4 !== void 0 ? _a4 : config.type.description,
        helpTopics() {
          var _a5, _b3, _c2, _d2;
          ...
          const defaults2 = [];
          if (config.env) {
            const env = process.env[config.env] === void 0 ? "" : `=${chalk_1.default.italic(process.env[config.env])}`;
            defaults2.push(`env: ${config.env}${env}`);
          }
          try {
            const defaultValueFn = (_a5 = config.defaultValue) !== null && _a5 !== void 0 ? _a5 : config.type.defaultValue;
            const defaultValueIsSerializable = (_b3 = config.defaultValueIsSerializable) !== null && _b3 !== void 0 ? _b3 : config.type.defaultValueIsSerializable;
          ...
          return [
            {
              ...
              usage,
              defaults: defaults2,
              description: (_d2 = (_c2 = config.description) !== null && _c2 !== void 0 ? _c2 : config.type.description) !== null && _d2 !== void 0 ? _d2 : "self explanatory"
            }
          ];
        },
        register(opts) {
        ...
        async parse({ nodes, visitedNodes }) {
          ...
          if (options.length === 0 && valueFromEnv !== void 0) {
            ...
            rawValue = (_b3 = (_a5 = options[0].value) === null || _a5 === void 0 ? void 0 : _a5.node.raw) !== null && _b3 !== void 0 ? _b3 : "true";
          } else {
            return Result.err({
              errors: [
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/effects.js
var require_effects = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/effects.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/circuitbreaker.js
var require_circuitbreaker = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/circuitbreaker.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.createCircuitBreaker = exports2.handleCircuitBreaker = exports2.versionFlag = exports2.helpFlag = void 0;
    var types_1 = require_types();
    var flag_1 = require_flag();
    var Result = __importStar(require_Result());
    var effects_1 = require_effects();
    exports2.helpFlag = (0, flag_1.flag)({
      long: "help",
      short: "h",
      type: types_1.boolean,
      description: "show help"
    });
    exports2.versionFlag = (0, flag_1.flag)({
      long: "version",
      short: "v",
      type: types_1.boolean,
    ...
    function createCircuitBreaker(withVersion) {
      return {
        register(opts) {
          exports2.helpFlag.register(opts);
          if (withVersion) {
            exports2.versionFlag.register(opts);
          }
        },
        helpTopics() {
          const helpTopics = exports2.helpFlag.helpTopics();
          if (withVersion) {
            helpTopics.push(...exports2.versionFlag.helpTopics());
          }
          return helpTopics;
        },
        async parse(context) {
          const help = await exports2.helpFlag.parse(context);
          const version = withVersion ? await exports2.versionFlag.parse(context) : void 0;
    ...
    exports2.createCircuitBreaker = createCircuitBreaker;
  }
});
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/subcommands.js
var require_subcommands = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/subcommands.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    function subcommands(config) {
      ...
      const type = {
        async from(str) {
          const commands = Object.entries(config.cmds).map(([name, cmd4]) => {
            var _a4;
            return {
              cmdName: name,
              names: [name, ...(_a4 = cmd4.aliases) !== null && _a4 !== void 0 ? _a4 : []]
            };
          });
          const cmd3 = commands.find((x) => x.names.includes(str));
          if (cmd3) {
            return cmd3.cmdName;
          }
          ...
          if (closeOptions) {
            ...
            errorMessage += `
Did you mean ${chalk_1.default.italic(option2)}?`;
          }
      ...
      function normalizeContext(context) {
        var _a4;
        if (((_a4 = context.hotPath) === null || _a4 === void 0 ? void 0 : _a4.length) === 0) {
      ...
      return {
        ...
        name: config.name,
        handler: (value) => {
          const cmd3 = config.cmds[value.command];
          return cmd3.handler(value.args);
        },
        register(opts) {
          for (const cmd3 of Object.values(config.cmds)) {
            cmd3.register(opts);
          }
        ...
        printHelp(context) {
          var _a4, _b3, _c2, _d2;
          const lines = [];
          const argsSoFar = (_b3 = (_a4 = context.hotPath) === null || _a4 === void 0 ? void 0 : _a4.join(" ")) !== null && _b3 !== void 0 ? _b3 : "cli";
          ...
          for (const key of Object.keys(config.cmds)) {
            const cmd3 = config.cmds[key];
            let description = (_c2 = cmd3.description) !== null && _c2 !== void 0 ? _c2 : "";
            description = description && " - " + description + " ";
            if ((_d2 = cmd3.aliases) === null || _d2 === void 0 ? void 0 : _d2.length) {
              const aliasTxt = cmd3.aliases.length === 1 ? "alias" : "aliases";
              const aliases = cmd3.aliases.join(", ");
        ...
        async parse(context) {
          ...
          (_a4 = context.hotPath) === null || _a4 === void 0 ? void 0 : _a4.push(parsed.value);
          const cmd3 = config.cmds[parsed.value];
          const parsedCommand = await cmd3.parse(context);
        ...
        async run(context) {
          ...
          (_a4 = context.hotPath) === null || _a4 === void 0 ? void 0 : _a4.push(parsedSubcommand.value);
          const cmd3 = config.cmds[parsedSubcommand.value];
          const commandRun = await cmd3.run(context);
    ...
    exports2.subcommands = subcommands;
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/binary.js
var require_binary2 = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/binary.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.binary = void 0;
    function binary(cmd3) {
      return {
        ...cmd3,
        run(context) {
          var _a4;
          const name = cmd3.name || context.nodes[1].raw;
          (_a4 = context.hotPath) === null || _a4 === void 0 ? void 0 : _a4.push(name);
          context.nodes.splice(0, 1);
          context.nodes[0].raw = name;
          context.visitedNodes.add(context.nodes[0]);
          return cmd3.run(context);
        }
      };
    }
    exports2.binary = binary;
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/utils.js
var require_utils = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/utils.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.flatten = exports2.flatMap = exports2.enumerate = exports2.entries = exports2.groupBy = exports2.padNoAnsi = void 0;
    ...
    exports2.padNoAnsi = padNoAnsi;
    function groupBy(objs, f) {
      var _a4;
      const result = {};
      for (const obj of objs) {
        const key = f(obj);
        result[key] = (_a4 = result[key]) !== null && _a4 !== void 0 ? _a4 : [];
        result[key].push(obj);
      }
      return result;
    }
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/command.js
var require_command = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/command.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
      ...
      return {
        ...
        helpTopics() {
          return (0, utils_1.flatMap)(Object.values(config.args).concat([circuitbreaker]), (x) => {
            var _a4, _b3;
            return (_b3 = (_a4 = x.helpTopics) === null || _a4 === void 0 ? void 0 : _a4.call(x)) !== null && _b3 !== void 0 ? _b3 : [];
          });
        },
        printHelp(context) {
          var _a4, _b3;
          const lines = [];
          let name = (_b3 = (_a4 = context.hotPath) === null || _a4 === void 0 ? void 0 : _a4.join(" ")) !== null && _b3 !== void 0 ? _b3 : "";
          if (!name) {
            name = config.name;
          }
        ...
        register(opts) {
          ...
          for (const [, arg] of argEntries) {
            (_a4 = arg.register) === null || _a4 === void 0 ? void 0 : _a4.call(arg, opts);
          }
        },
        async parse(context) {
          var _a4;
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/option.js
var require_option = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/option.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    function fullOption(config) {
      ...
      return {
        ...
        helpTopics() {
          ...
          const displayName = (_a5 = config.type.displayName) !== null && _a5 !== void 0 ? _a5 : "value";
          let usage = `--${config.long}`;
          if (config.short) {
            usage += `, -${config.short}`;
          }
          ...
          const defaultValueFn = (_b3 = config.defaultValue) !== null && _b3 !== void 0 ? _b3 : config.type.defaultValue;
          if (defaultValueFn) {
            try {
              const defaultValue = defaultValueFn();
              if ((_c2 = config.defaultValueIsSerializable) !== null && _c2 !== void 0 ? _c2 : config.type.defaultValueIsSerializable) {
                defaults2.push("default: " + chalk_1.default.italic(defaultValue));
              } else {
                defaults2.push("optional");
              }
          ...
          return [
            {
              ...
              usage,
              defaults: defaults2,
              description: (_e2 = (_d2 = config.description) !== null && _d2 !== void 0 ? _d2 : config.type.description) !== null && _e2 !== void 0 ? _e2 : "self explanatory"
            }
          ];
        },
        register(opts) {
        ...
        async parse({ nodes, visitedNodes }) {
          ...
          const valueFromEnv = config.env ? process.env[config.env] : void 0;
          const option3 = options[0];
          let rawValue;
          let envPrefix = "";
          const defaultValueFn = (_a5 = config.defaultValue) !== null && _a5 !== void 0 ? _a5 : config.type.defaultValue;
          if (option3 === null || option3 === void 0 ? void 0 : option3.value) {
            rawValue = option3.value.node.raw;
          } else if (valueFromEnv !== void 0) {
            rawValue = valueFromEnv;
            envPrefix = `env[${chalk_1.default.italic(config.env)}]: `;
          } else if (!option3 && typeof defaultValueFn === "function") {
            try {
              return Result.ok(defaultValueFn());
            } catch (e) {
              const message = `Default value not found for '--${config.long}': ${e.message}`;
            ...
            const raw = (option3 === null || option3 === void 0 ? void 0 : option3.type) === "shortOption" ? `-${option3 === null || option3 === void 0 ? void 0 : option3.key}` : `--${(_b3 = option3 === null || option3 === void 0 ? void 0 : option3.key) !== null && _b3 !== void 0 ? _b3 : config.long}`;
            return Result.err({
              errors: [
                {
                  nodes: options,
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/newparser/tokenizer.js
var require_tokenizer = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/newparser/tokenizer.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/newparser/parser.js
var require_parser2 = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/newparser/parser.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    function parseOptionValue(opts) {
      ...
      const shouldReadKeyAsFlag = !shouldReadKeyAsOption && (forceFlag.has(key) || ((_a4 = opts.peekToken()) === null || _a4 === void 0 ? void 0 : _a4.type) !== "char");
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/errorBox.js
var require_errorBox = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/errorBox.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.errorBox = void 0;
    var chalk_1 = __importDefault(require_source());
    var utils_1 = require_utils();
    var strip_ansi_1 = __importDefault(require_strip_ansi());
          ...
          if (node.type === "shortOptions") {
            ...
            for (const option2 of node.options) {
              if (error.nodes.includes(option2)) {
                s += chalk_1.default.red(option2.raw);
                failed = true;
              } else {
                s += chalk_1.default.dim(option2.raw);
              }
            }
    ...
    exports2.errorBox = errorBox;
  }
});

// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/runner.js
var require_runner = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/runner.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.parse = exports2.dryRun = exports2.runSafely = exports2.run = void 0;
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/restPositionals.js
var require_restPositionals = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/restPositionals.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.restPositionals = void 0;
    var Result = __importStar(require_Result());
    var types_1 = require_types();
          ...
          return [
            {
              ...
              category: "arguments",
              defaults: [],
              description: (_d2 = (_c2 = config.description) !== null && _c2 !== void 0 ? _c2 : config.type.description) !== null && _d2 !== void 0 ? _d2 : ""
            }
          ];
        },
        register(_opts) {
    ...
    exports2.restPositionals = restPositionals;
  }
});

// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/multiflag.js
var require_multiflag = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/multiflag.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    function multiflag(config) {
      return {
          ...
          return [
            {
              ...
              usage,
              defaults: [],
              description: (_a4 = config.description) !== null && _a4 !== void 0 ? _a4 : "self explanatory"
            }
          ];
        },
        register(opts) {
        ...
        async parse({ nodes, visitedNodes }) {
          ...
          const errors = [];
          for (const option2 of options) {
            const decoded = await Result.safeAsync(flag_1.boolean.from((_b3 = (_a4 = option2.value) === null || _a4 === void 0 ? void 0 : _a4.node.raw) !== null && _b3 !== void 0 ? _b3 : "true"));
            if (Result.isErr(decoded)) {
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/multioption.js
var require_multioption = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/multioption.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    function multioption(config) {
      return {
        helpTopics() {
          var _a4, _b3, _c2, _d2;
          const displayName = (_a4 = config.type.displayName) !== null && _a4 !== void 0 ? _a4 : "value";
          ...
          return [
            {
              ...
              usage,
              defaults: defaults2,
              description: (_d2 = config.description) !== null && _d2 !== void 0 ? _d2 : "self explanatory"
            }
          ];
        },
        register(opts) {
        ...
        async parse({ nodes, visitedNodes }) {
          ...
          const defaultValueFn = (_a4 = config.defaultValue) !== null && _a4 !== void 0 ? _a4 : config.type.defaultValue;
          ...
          const flagNodes = [];
          for (const option2 of options) {
            const providedValue = (_b3 = option2.value) === null || _b3 === void 0 ? void 0 : _b3.node.raw;
    ...
    exports2.multioption = multioption;
  }
});

// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/union.js
var require_union = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/union.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/oneOf.js
var require_oneOf = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/oneOf.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/rest.js
var require_rest = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/rest.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.rest = void 0;
    var Result = __importStar(require_Result());
    function rest(config) {
      return {
        helpTopics() {
          var _a4, _b3;
          const displayName = (_a4 = config === null || config === void 0 ? void 0 : config.displayName) !== null && _a4 !== void 0 ? _a4 : "arg";
          return [
            {
              usage: `[...${displayName}]`,
              category: "arguments",
              defaults: [],
              description: (_b3 = config === null || config === void 0 ? void 0 : config.description) !== null && _b3 !== void 0 ? _b3 : "catches the rest of the values"
            }
          ];
        },
        register() {
...
// ../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/index.js
var require_cjs = __commonJS({
  "../../node_modules/.pnpm/cmd-ts@0.13.0/node_modules/cmd-ts/dist/cjs/index.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.rest = exports2.oneOf = exports2.union = exports2.multioption = exports2.multiflag = exports2.restPositionals = exports2.parse = exports2.run = exports2.runSafely = exports2.dryRun = exports2.positional = exports2.option = exports2.flag = exports2.command = exports2.binary = exports2.extendType = exports2.subcommands = void 0;
    var subcommands_1 = require_subcommands();
    Object.defineProperty(exports2, "subcommands", { enumerable: true, get: function() {
      return subcommands_1.subcommands;
    } });
    var type_1 = require_type();
    Object.defineProperty(exports2, "extendType", { enumerable: true, get: function() {
    ...
    var positional_1 = require_positional();
    Object.defineProperty(exports2, "positional", { enumerable: true, get: function() {
    ...
    Object.defineProperty(exports2, "runSafely", { enumerable: true, get: function() {
    ...
    Object.defineProperty(exports2, "restPositionals", { enumerable: true, get: function() {
      return restPositionals_1.restPositionals;
    } });
    var multiflag_1 = require_multiflag();
    Object.defineProperty(exports2, "multiflag", { enumerable: true, get: function() {
      return multiflag_1.multiflag;
    } });
    var multioption_1 = require_multioption();
    Object.defineProperty(exports2, "multioption", { enumerable: true, get: function() {
    ...
    Object.defineProperty(exports2, "oneOf", { enumerable: true, get: function() {
...
// src/constants.ts
var DEFAULT_CONFIG_FILE_NAME = "workspace-env.json";
  ...
  if (check)
    return ZodAny.create().superRefine((data, ctx) => {
      ...
      if (!check(data)) {
        ...
        const _fatal = (_b3 = (_a4 = p.fatal) !== null && _a4 !== void 0 ? _a4 : fatal) !== null && _b3 !== void 0 ? _b3 : true;
...
var workspaceEnvConfigInputSchema = z.object({
  workspaces: z.string().array().optional(),
  // pull from package manager settings if not provided
  envDir: z.string().optional(),
  // use root dir if not provided
  syncEnvsTo: z.string().array().optional(),
  // sync to all workspaces if not provided
  envFilePatterns: z.string().array().optional().default(defaultEnvFilePatterns)
});
var noGlobStringSchema = z.string().refine((value) => !value.includes("*"), {
  message: "This string cannot contain a glob pattern"
});
var workspaceEnvFinalConfigSchema = z.object({
...
var cliOptionsInputSchema = z.object({
  inWatchMode: z.boolean().optional(),
  configFilePath: z.string().optional()
});
var cliOptionsFinalSchema = cliOptionsInputSchema.required();
var DEFAULT_CLI_OPTIONS_FINAL = {
...
// src/readConfig.ts
var pmpmWorkspacesDataSchema = z.object({
  packages: z.array(z.string()).optional()
});
var readPnpmWorkspaces = async () => {
  const rawPnpmWorkspacesFileContent = await import_promises2.default.readFile("pnpm-workspace.yaml", "utf8").catch(() => import_yaml.default.stringify({}));
  const untypedPnpmWorkspacesFileData = import_yaml.default.parse(
...
var neededPackageJsonDataSchema = z.object({
  workspaces: z.array(z.string()).optional()
});
var readPackageWorkspaces = async () => {
  const rawPackageJsonFileContent = await import_promises2.default.readFile("package.json", "utf8").catch(() => JSON.stringify({}));
...
var readWorkspacesFromProject = async () => {
  var _a4;
  const result = (_a4 = await readPackageWorkspaces()) != null ? _a4 : await readPnpmWorkspaces();
  if (result === void 0) {
    throw new Error("No workspaces found");
  }
  return result;
};
var getLastPathSegment = (path3) => {
...
var readConfig = async ({
  ...
  var _a4, _b3, _c2;
  const rawConfigFileContents = await import_promises2.default.readFile(configFilePath, "utf8").catch(() => "{}");
  ...
  const workspaces = (_a4 = configData.workspaces) != null ? _a4 : await readWorkspacesFromProject();
  ...
  const outputData = {
    ...
    envDir: (_b3 = configData.envDir) != null ? _b3 : "./",
    syncEnvsTo: new Set((_c2 = configData.syncEnvsTo) != null ? _c2 : workspaceNames),
...
var listEnvFilePaths = async (dir, patterns) => {
  const files = await glob(
    patterns.map((p) => import_path.default.join(dir, p)),
    {
      dot: true
    }
  );
...
var deleteAllEnvFilesInDir = async (dir, patterns) => {
  ...
  await Promise.all(
    filePaths.map(async (filePath) => {
      const fileExists = await import_promises3.default.access(filePath).then(() => true).catch(() => false);
      if (!fileExists) {
        return;
      }
      await import_promises3.default.rm(filePath);
    })
  );
};
var getLastSegmentOfPath = (path3) => {
  const pathSegments = path3.split("/");
  const lastSegment = pathSegments[pathSegments.length - 1];
  if (!lastSegment) {
    return path3;
...
var syncEnvs = async (cliArgs = DEFAULT_CLI_OPTIONS_FINAL) => {
  ...
  const workspacePathsToSyncTo = [...config.workspaces].filter(
    (workspacePath) => [...config.syncEnvsTo].some(
      (syncPath) => workspacePath.endsWith(syncPath)
    )
  );
  await Promise.all(
    workspacePathsToSyncTo.map(
      (workspaceDirPath) => deleteAllEnvFilesInDir(workspaceDirPath, [...config.envFilePatterns])
    )
  );
  await Promise.all(
    envFilesToCopy.map(
      async (envSourceFilePath) => Promise.all(
        workspacePathsToSyncTo.map(async (workspaceDirPath) => {
          const envDestFilePath = import_path.default.join(
            workspaceDirPath,
            getLastSegmentOfPath(envSourceFilePath)
          );
          await import_promises3.default.copyFile(envSourceFilePath, envDestFilePath);
          return;
        })
      )
    )
...
// src/cli/command.ts
var cmd = __toESM(require_cjs());
var theCommand = cmd.command({
  name: "workspace-env",
...
// src/cli/bin.ts
var cmd2 = __toESM(require_cjs());
cmd2.run(theCommand, process.argv.slice(2));
